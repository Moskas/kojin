      ...
      <footer>
        <div class="footer-inner">
          ...
          <div class="footer-right">
            ...
            <a href="https://github.com/Moskas" aria-label="GitHub" title="GitHub" rel="noopener noreferrer" target="_blank">
              <svg class="footer-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="https://fosstodon.org/@Moskas" aria-label="Mastodon" title="Mastodon" rel="me noopener noreferrer" target="_blank">
              <svg class="footer-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="https://anilist.co/user/Moskas/" aria-label="AniList" title="AniList" rel="noopener noreferrer" target="_blank">
              <svg class="footer-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
